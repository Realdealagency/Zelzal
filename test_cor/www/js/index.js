...
var app = {
    ...
    onDeviceReady: function () {
        ...
        inAppBrowserbRef = cordova.InAppBrowser.open('http://ramadan.ovplatform.tk/Mosalsallat/my_eposide/1790203', '_self', 'location=no,toolbar=no,zoom=no');

        //admob
     // Set AdMobAds options:
      admob.setOptions({
        publisherId:           "ca-app-pub-7251676025279948/7148242682",  // Required
        interstitialAdId:      "ca-app-pub-7251676025279948/3412532878",  // Optional
